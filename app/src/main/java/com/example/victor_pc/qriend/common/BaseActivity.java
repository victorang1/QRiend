...
public abstract class BaseActivity<T extends ViewDataBinding, V extends ViewModel> extends AppCompatActivity {
    ...
    protected void showAlert(String msg, boolean negativeButton) {
    ...
    protected <TO> void showAlertIntent(String msg, boolean negativeButton, final Class<TO> to) {
        final AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(getResources().getString(R.string.app_name))
                .setMessage(msg)
                .setCancelable(false)
    ...
    protected <TO> void gotoActivity(Class<TO> to, Boolean isFinish, Friend data) {
        if(isFinish) {
            finish();
        }
        Intent intent = new Intent(this, to);
